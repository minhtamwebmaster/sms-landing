                  ...
                  {categories.filter(cat => cat !== "Tất cả").map((category) => (
                    <li key={category}>
                      <button
                        ...
                        className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-gray-50 w-full text-left"
                      >
                    ...
                    <div key={post.id} className="flex gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800 mb-1 line-clamp-2">
                          <Link href={`/news/${post.id}`} className="hover:text-primary-600">
                            {post.title}
                          </Link>
                        </h4>
